...
public class CongresspersonDetailTest {
    ...
    public void test1(){
        ...
        congresspersonDetail.setCongresspersonId(tempCongressperson.getId());
        ...
        assertEquals(congresspersonDetail.toString(), selectedCongresspersonDetail.toString());
        ...
        Congressperson selectedCongressperson = congresspersonRepository.findOne(tempCongressperson.getId());
        ...
        Congressperson selectedCongressperson1 = congresspersonRepository.findOne(tempCongressperson.getId());
        //실패
        ...
        Congressperson selectedCongressperson2 = congresspersonRepository.findOne(tempCongressperson.getId());
        //성공
...
//        congresspersonRepository.save(tempCongressperson);
    ...
    public void persistanceContextTest() {
        ...
        Congressperson foundedCongressperson = em.find(Congressperson.class, tempCongressperson.getId());
